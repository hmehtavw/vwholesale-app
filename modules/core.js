...
function _applyCustomerTheme() {
  ...
  const vars = {
    '--bg':'#F4F4F4','--bg1':'#F4F4F4','--bg2':'#FFFFFF','--bg3':'#F0F0F0',
    '--bg4':'#E8E8E8','--sheet-bg':'#FFFFFF','--border':'#E5E5E5','--border2':'#D0D0D0',
    '--text':'#111111','--text1':'#111111','--text2':'#444444','--text3':'#777777',
    '--gold':'#16783A','--gold-light':'#EBF7EF','--gold-dark':'#0D5C2C',
    '--gold-muted':'rgba(22,120,58,0.10)','--gold-border':'rgba(22,120,58,0.25)',
    '--header-bg':'#16783A','--green':'#16783A',
  };
  ...
  // shop.js renders its own complete header (Deliver To / logo / cart / account)
  // Hide index.html's app-header entirely to avoid double header
  const hdr = document.getElementById('app-header');
  if (hdr) hdr.style.display = 'none';

  // Bottom nav white with green active
  const nav = document.getElementById('bottom-nav');
  if (nav) nav.style.cssText = 'background:#fff!important;border-top:1px solid #E5E5E5!important;box-shadow:0 -2px 10px rgba(0,0,0,.06)!important';
}
